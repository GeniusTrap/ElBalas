...
const handleTransfertSuccess = (transfertData) => {
    ...
    <div className="h-full w-full relative" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="absolute top-0 left-0 w-full z-50 pointer-events-none">
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 w-full max-w-4xl px-4 pointer-events-auto">
          <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-xl p-2 md:p-3 flex flex-col md:flex-row gap-2 md:gap-3 items-center">
  ...
  <input
    ...
    className="w-full px-3 md:px-4 py-2 md:py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all text-xs md:text-sm"
  />
  ...
  className="px-2 md:px-4 py-2 md:py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold text-xs md:text-sm transition-all transform hover:scale-105 flex items-center gap-1 md:gap-2"
>
  ...
  Supprimer
              ...
              <button
                ...
                className="px-2 md:px-4 py-2 md:py-2.5 bg-green-500 hover:bg-green-600 text-white rounded-lg font-semibold text-xs md:text-sm transition-all transform hover:scale-105 flex items-center gap-1 md:gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  className="px-2 md:px-4 py-2 md:py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-semibold text-xs md:text-sm transition-all transform hover:scale-105 flex items-center gap-1 md:gap-2"
>
  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
